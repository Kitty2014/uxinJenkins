...
//
//public class checkAuto_9_9_UiSelector竺 extends TestBase{
...
//    	driver.scrollTo("黑");
//	
//    	driver.findElementByAndroidUIAutomator("new UiSelector().resourceId(\"android:id/text1\").text(\"黑\")").click();
//    	
//    	//车牌号
...
//       
//       driver.scrollTo("黑龙江");
//       driver.findElementByAndroidUIAutomator("new UiSelector().resourceId(\"com.youxinpai.checkauto.act:id/tv_cartype\").text(\"黑龙江\")").click();
//       
//       
