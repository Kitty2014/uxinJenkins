package com.checkAuto.appium.utils;
...
//		capabilities.setCapability(MobileCapabilityType.,CommonUtils.RESETKEYBOARD);
//		
		capabilities.setCapability("unicodeKeyboard",
				CommonUtils.UNICODEKEYBOARD);
		capabilities.setCapability("resetKeyboard",
				CommonUtils.RESETKEYBOARD);
